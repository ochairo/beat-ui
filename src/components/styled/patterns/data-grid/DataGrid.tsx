...
import {
  DataGrid as HeadlessDataGrid,
  type DataGridCell,
  type DataGridCellPresentationState,
...
} from "../../../headless/patterns/DataGrid";
...
function getCellButtonStyle(state: DataGridCellPresentationState): string {
